//// The old interpreter's host side of dynamic import(),
//// HostLoadImportedModule (§16.2.1.8), kept only while `arc/vm` still runs.
//// The public one is `arc/module_host`.
////
...
// objects behind the typed accessors of `arc/vm/module_registry` — shared with
