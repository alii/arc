...
pub fn has_property(heap: Heap(host), ref: Ref, key: PropertyKey) -> Bool {
...
/// throw a TypeError.
pub fn is_array(h: Heap(host), val: JsValue) -> Result(Bool, Nil) {
  case val {
...
pub fn is_array_ref(h: Heap(host), ref: Ref) -> Result(Bool, Nil) {
  case heap.read(h, ref) {
