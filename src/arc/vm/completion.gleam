...
pub type Completion(host) {
  NormalCompletion(value: JsValue, heap: Heap(host))
  ThrowCompletion(value: JsValue, heap: Heap(host))
  ...
  YieldCompletion(value: JsValue, heap: Heap(host))
  ...
  AwaitCompletion(value: JsValue, heap: Heap(host))
}
