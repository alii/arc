%% generated by scripts/gen_tz_links.escript from /usr/share/zoneinfo/tzdata.zi, do not edit
-module(arc_tz_links_ffi).
-export([version/0, primary_zones/0, links/0, names_by_lowercase/0]).

version() -> <<"2026c-rearguard">>.
