...
pub fn main() -> Nil {
  check(
    "if(a==b)",
    "var a=1,b=2;if(a==b){console.log('eq')}else{console.log('ne')}",
  )
  check(
    "if(a!=b)",
    "var a=1,b=2;if(a!=b){console.log('ne')}else{console.log('eq')}",
  )
  check("while(i==0)", "var i=0,n=0;while(i==0){n++;if(n>3)i=1}console.log(n)")
  check(
    "if(!(a==b))",
    "var a=1,b=1;if(!(a==b)){console.log('t')}else{console.log('f')}",
  )
  check(
    "if(a in o)",
    "var o={p:1};if('zz' in o){console.log('t')}else{console.log('f')}",
  )
  check(
    "if(x instanceof A)",
    "function A(){};function B(){};var x=new B();if(x instanceof A){console.log('t')}else{console.log('f')}",
  )
  check(
    "if(a<b)",
    "var a=3,b=2;if(a<b){console.log('t')}else{console.log('f')}",
  )
  check(
    "str<str cond",
    "var a='b',b='a';if(a<b){console.log('t')}else{console.log('f')}",
  )
