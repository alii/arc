...
idx(<<"NAMES_NUMBERS">>) -> ?NAMES_NUMBERS;
idx(<<"NAMES_TEXTS">>) -> ?NAMES_TEXTS;
idx(<<"NAMES_NEXT">>) -> ?NAMES_NEXT;
idx(<<"NAMES_PINNED">>) -> ?NAMES_PINNED;
idx(<<"NAMES_ARITY">>) -> ?NAMES_ARITY;
idx(<<"FT_KEYS">>) -> ?FT_KEYS;
idx(<<"FT_FUNCTIONS">>) -> ?FT_FUNCTIONS;
idx(<<"FT_ARITY">>) -> ?FT_ARITY;
...
tag(<<"PRIVATE_TAG">>) -> ?PRIVATE_TAG;
tag(<<"NAMES_TAG">>) -> ?NAMES_TAG;
tag(<<"FT_TAG">>) -> ?FT_TAG;
