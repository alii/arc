...
pub fn table() -> DirectHost {
  ...
  DirectHost(
    ...
    ops: dict.from_list([
      ...
      #("num_add", HostOp(ops_ffi, "num_add", Pure)),
      #("num_sub", HostOp(ops_ffi, "num_sub", Pure)),
      #("num_mul", HostOp(ops_ffi, "num_mul", Pure)),
      #("num_div", HostOp(ops_ffi, "num_div", Pure)),
      #("num_neg", HostOp(ops_ffi, "num_neg", Pure)),
      #("int_mod", HostOp(ops_ffi, "int_mod", Pure)),
      #("add_prim", HostOp(ops_ffi, "add_prim", Pure)),
      ...
      #("strict_eq_i32", HostOp(ops_ffi, "strict_eq", Pure)),
