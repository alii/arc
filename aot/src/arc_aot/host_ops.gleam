...
pub fn table() -> DirectHost {
  ...
  DirectHost(
    ...
    ops: dict.from_list([
      ...
      #("get_prop", HostOp(obj, "t_get_prop", Mut)),
      #("get_by_value", HostOp(obj, "t_get_by_value", Mut)),
      ...
      #("get_prop_fast", HostOp(obj_fast_ffi, "t_get_prop", ReadMiss)),
      #("erl_band", HostOp(erl, "band", Pure)),
      #("erl_bsr", HostOp(erl, "bsr", Pure)),
      #("erl_bsl", HostOp(erl, "bsl", Pure)),
      #("erl_rem", HostOp(erl, "rem", Pure)),
      #("set_prop", HostOp(obj, "t_set_prop", Mut)),
      #("set_prop_strict", HostOp(obj, "t_set_prop_strict", Mut)),
      #("set_prop_site", HostOp(obj_fast_ffi, "t_set_prop", MutUnit)),
      #("set_props_init", HostOp(obj_fast_ffi, "t_set_props_init", MutUnit)),
      ...
      #("global_get_fast", HostOp(obj_fast_ffi, "t_global_get", ReadMiss)),
      #("global_get_miss", HostOp(obj_fast_ffi, "t_global_get_miss", Mut)),
      #("global_this", HostOp(obj, "t_global_this", Read)),
      #("global_set", HostOp(obj, "t_global_set_key", MutUnit)),
      #("global_set_strict", HostOp(obj, "t_global_set_strict_key", MutUnit)),
      #("global_typeof", HostOp(obj, "t_global_typeof_key", Mut)),
      #("global_delete", HostOp(lang, "t_global_delete", Mut)),
      #("declare_global_var", HostOp(env, "t_create_global_var", MutUnit)),
      #("declare_global_fn", HostOp(env, "t_create_global_fn", MutUnit)),
