...
pub fn table() -> DirectHost {
  ...
  DirectHost(
    ...
    ops: dict.from_list([
      ...
      #("has_prop", HostOp(obj, "t_has_prop_any", Mut)),
      #("delete_prop", HostOp(obj, "t_delete_prop_any", Mut)),
      #("delete_prop_strict", HostOp(obj, "t_delete_prop_strict_any", Mut)),
      #("own_keys", HostOp(obj, "t_own_keys", Mut)),
      #("copy_data_props", HostOp(lang, "t_copy_data_props", Mut)),
      #("object_rest", HostOp(lang, "t_object_rest_any", Mut)),
      ...
      #("define_method", HostOp(class, "t_define_method_any", MutUnit)),
      ...
      #("super_get", HostOp(class, "t_super_get_any", Mut)),
      #("super_set", HostOp(class, "t_super_set_any", Mut)),
